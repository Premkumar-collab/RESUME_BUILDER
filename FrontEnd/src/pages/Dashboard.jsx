...
const Dashboard = () => {
  ...
  const fetchAllResumes = async () => {
    try {
      setLoading(true);
      const response = await axiosInstace.get(API_PATHS.RESUME.GET_ALL);
  ...
  const handleDeleteResume = async () => {
    ...
    try {
      await axiosInstace.delete(API_PATHS.RESUME.DELETE_RESUME(resumeToDelete));
      toast.success("Resume Deleted successfully");
      fetchAllResumes();
    } catch (error) {
      console.error("Error in deleting resume", error);
      toast.error("Faild to delete resume");
    } finally {
        ...
        >
          <div className="p-4">
            ...
            <p className={styles.deleteText}>
              Are you sure you want to delete this resume? This action can't be
              undone.
            </p>
          </div>
        </Modal>
