  ...
  return (
    <>
      ...
      <div className="relative w-full h-4 bg-white/5 backdrop-blur-2xl overflow-hidden rounded-full border border-white/10">
        ...
        {/* MAIN PROGRESS BAR */}
        <div
          className="relative h-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-violet-600 animate-flow bg-[length-200%] transition-all duration-700 ease-out rounded-full overflow-hidden animate-pulse-glow"
        ...
        {progress > 0 && (
          <div
            className="absolute top-0 h-full w-8 bg-gradient-to-r from-transparent via-white/60 blur-sm"
