    ...
    <>
      {user && (
        <div className={cardStyles.profileCard}>
          ...
          <div>
            <div className={cardStyles.profileName}>{name || "Guest"}</div>
...
export const ResumeSummaryCard = ({
  ...
  return (
    <div
      ...
      onClick={onSelect}
      onMouseEnter={() => setIsHovered(true)} // for mobile or swipe
    ...
    >
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          ...
          {/* HOVER EFFECT */}
          <div className="abosolute inset-0 bg-gradient-to-t from-violet-100/30 to-transparent opacity-0 group-hover:opacity-100 trasition-opacity duration-300"></div>
        </div>
      ) : (
