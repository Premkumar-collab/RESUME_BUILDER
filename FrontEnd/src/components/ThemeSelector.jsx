  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 p-4 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100">
          <Tabs
            tabs={TAB_DATA}
            activeTab={tabValue}
          ...
          <button
            className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 trasition-all shadow-lg hover:shadow-xl"
